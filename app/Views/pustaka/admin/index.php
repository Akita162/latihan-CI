...
<div class="container-fluid">
      ...
      <div class="card border-left-danger shadow h-100 py-2 bg-primary">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <a href="user/anggota"><i class="fas fa-users fa-3x text-warning"></i></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card border-left-primary shadow h-100 py-2 bg-warning">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <a href="buku"><i class="fas fa-book fa-3x text-primary"></i></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card border-left-success shadow h-100 py-2 bg-danger">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <a href="user"><i class="fas fa-user-tag fa-3x text-success"></i></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="table-responsive table-bordered col-sm-5 mr-auto ml-auto mt-2">
      <div class="page-header">
        <span class="fas fa-users text-primary mt-2"> Data User</span>
        <a href="user/dataUser" class="text-danger">
          <i class="fas fa-search mt-2 float-right" aria-hidden="true"> Tampilkan</i>
        </a>
      </div>
    ...
    <div class="table-responsive table-bordered col-sm-5 mr-auto ml-auto mt-2">
      <div class="page-header">
        ...
        <a href="buku"><i class="fas fa-search text-primary mt-2 float-right" aria-hidden="true"> Tampilkan</i></a>
      </div>
